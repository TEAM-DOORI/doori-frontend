        ...
        >
          <View style={styles.content}>
            ...
            <View style={styles.actionBlock}>
              <View style={styles.characterSection} pointerEvents="box-none">
                <View style={styles.speechGroup} pointerEvents="none">
                  <View style={styles.speechBubble}>
                    <Text weight="medium" style={styles.speechText}>
                      음모르겠다~
                    </Text>
                  </View>
              ...
              >
                <Text weight="medium" style={styles.secondaryButtonText}>
                  회원가입하기
                </Text>
              </Pressable>
              </View>
